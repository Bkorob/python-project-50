...
first_file = json.load(open('gendiff/files/json/file2.json'))
...
def generate_result(first_file, second_file):
    ...
    for first_key in first_file:
        if first_key in second_file:
            if first_file[first_key] == second_file[first_key]:
