...
def generate_diff(filename1, filename2):
	with open('/home/baka311/hexlet_g/python-project-50/gendiff/files/json/file1.json') as json_file:
		filename1 = json.loads(json_file)
	with open('/home/baka311/hexlet_g/python-project-50/gendiff/files/json/file2.json') as json_file:
